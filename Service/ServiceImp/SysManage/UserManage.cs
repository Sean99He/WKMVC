...
namespace Service.ServiceImp
{
	...
	{
		private UserInfoManage _UserInfoManage;
		public IUserInfoManage UserInfoManage
		{
			get { if (_UserInfoManage == null) _UserInfoManage = new UserInfoManage(); return _UserInfoManage; }
		}
		private UserPermissionManage _UserPermissionManage;
		public IUserPermissionManage UserPermissionManage
		{
			get { if (_UserPermissionManage == null) _UserPermissionManage = new UserPermissionManage(); return _UserPermissionManage; }
		}
		private UserRoleManage _UserRoleManage;
		public IUserRoleManage UserRoleManage
		{
			get { if (_UserRoleManage == null) _UserRoleManage = new UserRoleManage(); return _UserRoleManage; }
		}
		private PostUserManage _PostUserManage;
		IPostUserManage PostUserManage
		{
			get { if (_PostUserManage == null) _PostUserManage = new PostUserManage(); return _PostUserManage; }
		}
		private UserDepartmentManage _UserDepartmentManage;
		public IUserDepartmentManage UserDepartmentManage
		{
			get { if (_UserDepartmentManage == null) _UserDepartmentManage = new UserDepartmentManage(); return _UserDepartmentManage; }
		}
		private DepartmentManage _DepartmentManage;
		public IDepartmentManage DepartmentManage
		{
			get { if (_DepartmentManage == null) _DepartmentManage = new DepartmentManage(); return _DepartmentManage; }
		}
		private PermissionManage _PermissionManage;
		public IPermissionManage PermissionManage
		{
			get { if (_PermissionManage == null) _PermissionManage = new PermissionManage(); return _PermissionManage; }
		}
		/// <summary>
		/// 管理用户登录验证
		/// </summary>
		...
		public Domain.SYS_USER UserLogin(string useraccount, string password)
		{
			...
			//而不能通过再次加密输入的密码来匹配
			if (entity != null && new AESCrypt().Decrypt(entity.PASSWORD) == password)
			{
				return entity;
			}
			return null;
			...
			if (cookie != null)
			{
				...
				if (!string.IsNullOrEmpty(cookie.Value))
				{
					...
					try
					{
						...
						if (jsonFormat != null)
						{
							var users = UserLogin(jsonFormat.username, new AESCrypt().Decrypt(jsonFormat.password));
							if (users != null)
